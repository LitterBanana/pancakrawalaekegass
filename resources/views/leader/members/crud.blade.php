...
@section('content')
    ...
    <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
        ...
        <a href="{{ route('leader.members.index') }}" class="inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold text-gray-600 bg-transparent border border-gray-200 rounded-lg hover:bg-gray-50 hover:text-gray-900 transition-colors">Kembali Ke Daftar</a>
    </div>
    <div class="p-6">
        <p class="text-sm text-gray-600 mb-6">Halaman CRUD ini menampilkan anggota referral Anda dengan struktur yang mudah dikembangkan: daftar anggota, detail, dan aksi manajemen.</p>
                    ...
                    @forelse($members as $member)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600 space-x-2">
                                <button class="inline-flex items-center justify-center px-3 py-1.5 text-xs font-semibold text-gray-400 bg-transparent border border-gray-200 rounded-md cursor-not-allowed" disabled>Edit</button>
                                <button class="inline-flex items-center justify-center px-3 py-1.5 text-xs font-semibold text-gray-400 bg-transparent border border-gray-200 rounded-md cursor-not-allowed" disabled>Hapus</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-8 text-center text-gray-500 text-sm">Belum ada anggota untuk ditampilkan.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
